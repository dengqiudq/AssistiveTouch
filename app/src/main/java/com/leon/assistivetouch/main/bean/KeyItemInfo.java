...
public class KeyItemInfo {
	...
	public static void doKeyEvent (String data,Context context) {
		...
		case KEY_MENU:
			...
			break;
		case KEY_SETTING:
			KeyAction.doSettingAction(context);
			break;
		default:
			return;
		}
	...
	public static int getKeyResource (String data) {
		...
		case KEY_RECENT:
			...
			break;
		case KEY_SETTING:
			res = R.drawable.ic_sysbar_setting;
			break;
		}
		return res;
	}
	...
	public static KeyItemInfo getKeyItemInfo (Context context, int type, String data) {
		...
		case KEY_HIDE:
			...
			break;
		case KEY_SETTING:
			title = context.getString(R.string.key_setting_name);
			res = R.drawable.ic_sysbar_setting;
			break;
		}
